package wtf.cephetir.voidmenu.gui.mainmenu.comp;
...
public abstract class GuiScreen extends net.minecraft.client.gui.GuiScreen {
    ...
    protected List<CustomButton> customButtonList = Lists.newArrayList();

    /**
     * The button that was just pressed.
     */
    private GuiButton selectedButton;
    private CustomButton selectedCustomButton;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (CustomButton customButton : this.customButtonList) {
            customButton.drawButton(this.mc, mouseX, mouseY);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            for (CustomButton customButton : this.customButtonList) {
                ...
                if (customButton.mousePressed(this.mc, mouseX, mouseY)) {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        if (this.selectedCustomButton != null && state == 0) {
            this.selectedCustomButton.mouseReleased(mouseX, mouseY);
            this.selectedCustomButton = null;
        }
    }
